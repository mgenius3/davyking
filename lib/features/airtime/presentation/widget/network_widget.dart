...
//         GestureDetector(
//             onTap: () {
//               airtimeIndexController.setNetwork(0);
//             },
...
//                 label: 'MTN',
//                 isSelected:
//                     airtimeIndexController.selectedNetwork.value == 0))),
//         GestureDetector(
//           onTap: () {
//             airtimeIndexController.setNetwork(1);
//           },
//           child: Obx(() => NetworkCard(
...
//         GestureDetector(
//           onTap: () {
//             airtimeIndexController.setNetwork(2);
//           },
//           child: Obx(() => NetworkCard(
...
//         GestureDetector(
//           onTap: () {
//             airtimeIndexController.setNetwork(3);
//           },
//           child: Obx(() => NetworkCard(
...
class AirtimeNetworkWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final AirtimeIndexController airtimeIndexController = Get.find<AirtimeIndexController>();
