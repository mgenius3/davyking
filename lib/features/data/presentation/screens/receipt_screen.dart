...
class DataReceiptScreen extends StatelessWidget {
  ...
  Widget _buildHeader() {
    return Column(
      children: [
        const TopHeaderWidget(data: TopHeaderModel(title: 'Data Receipt')),
        const SizedBox(height: 20),
        Container(
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: serviceId == 'Smile'
                      ? Image.asset(
                          ImagesConstant.smileIcon,
                          width: 32,
                          height: 32,
                        )
                      : SvgPicture.asset(
