              ...
              children: [
                ...
                Obx(() => controller.giftCardType.value == 'ecode'
                    ? TextFormField(
                        ...
                        decoration: const InputDecoration(
                          ...
                          filled: true,
                          fillColor: Color(0xFFF7F7F7),
                          labelText: 'Enter E-code (e.g., XXXX-XXXX-XXXX-XXXX)',
                          labelStyle: TextStyle(color: Colors.black),
                        ),
                      )
                ...
                Obx(() {
                  ...
                  return Container(
                    ...
                    child: Text(
                      'Sell Rate: ${Symbols.currency_naira}${(double.tryParse(countryRate.sellRate) ?? 0.0)}',
                      style: const TextStyle(
                        color: Color(0xE5093030),
                        fontSize: 12,
                        fontFamily: 'Poppins',
                ...
                Obx(() => controller.giftCardType.value == 'physical'
                    ? Container(
                        width: Get.width,
                        padding: const EdgeInsets.all(12),
                        decoration: ShapeDecoration(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 10),
                            Obx(() => controller.giftCardImage.value == null
                                ? ElevatedButton.icon(
                                    onPressed: controller.uploadGiftCardImage,
                                    icon: const Icon(Icons.upload),
                                    label: const Text('Choose Image'),
                                    style: ElevatedButton.styleFrom(
                                      backgroundColor: Colors.white,
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          TextButton(
                                            onPressed:
                                                controller.uploadGiftCardImage,
                                            child: const Text('Change Image'),
                                          ),
                                          TextButton(
                                            onPressed:
                                                controller.removeGiftCardImage,
