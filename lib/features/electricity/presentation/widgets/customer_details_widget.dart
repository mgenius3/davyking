...
class CustomerDetailsWidget extends StatelessWidget {
  final ElectricityIndexController
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() => controller.customerDetails.isNotEmpty
                  ? Text(
                      'Min purchase amount: ${Symbols.currency_naira}${controller.customerDetails['min_purchase_amount']}',
              ...
              Obx(() => controller.customerDetails.isNotEmpty
                  ? Text(
                      'Max purchase amount: ${Symbols.currency_naira}${controller.customerDetails['max_purchase_amount']}',
                      style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                            fontSize: 14,
                            fontWeight: FontWeight.w500,
                            color: Colors.blueGrey.shade600,
