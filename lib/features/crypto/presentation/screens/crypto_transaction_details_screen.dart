          ...
          child: Column(
            children: [
              const TopHeaderWidget(
                data: TopHeaderModel(title: 'Crypto Transaction Details'),
              ),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildDetailItem('Cryptocurrency',
                        ...
                        if (transaction.type.toLowerCase() == 'buy')
                          _buildDetailItem('Wallet Address',
                              transaction.walletAddress ?? 'N/A'),
                        if (transaction.type.toLowerCase() == 'buy')
                          _buildDetailItem(
                              'Payment Method',
                              transaction.paymentMethod?.capitalizeFirst ??
                                  'N/A'),
                        if (transaction.type.toLowerCase() == 'sell')
                          _buildDetailItem(
                              'Admin Wallet Address',
                              transaction.cryptoCurrency.walletAddress ??
                                  'N/A'),
                        _buildDetailItem('Confirmations',
